...
/* This program emulates a SuperMarket transaction with a recognized customer. 
 * Each customer is eligible for a discount depending on their age, and each available
 * item that they purchase is recognized as taxable or non-taxable. All relevant information
 * for the transaction (including customer name, customer age, purchasable items, item prices,
 * and item taxability) is stored in arrays, which are declared at the beginning of the
 * program. Class constants include tax and discount rates.
 */
...
public class SuperMarket {
  ...
  public static void displayMessage(String str) {
    ...
    if (str.equals("customer")){
      ...
      if (str.equals("action")) {
        ...
        // if array is not needed:
        else{
          
          // print inquiry for quantity of item
  ...
  public static int getCustomerID(){
    ...
    // print array for customers and assign variable with valid user input
  ...
  public static String getArrayList(String[] list){
    ...
    // for loop to create string from array 
  ...
  public static double getQuantity(String str){
    ...
    //print quantity inquiry to user and assign variable with user input
    displayMessage(str);
  ...
  public static void genTransaction(){
    ...
    // get array list for actions and assign variable with valid user input
    ...
    while (userAction != 0) {
      ...
      // declare and assigning variable with user input with itemQuantity method call
      double itemQuantity = getQuantity(ITEMS[userItem]);
      
      // declare and assign variable with calculation of item cost
      double totalItemCost = PRICE[userItem] * itemQuantity;
      
      // determination and running total calculation of tax
      if (TAXABLE[userItem]) {
      ...
      // break in case of user choice of "cancel" and print termination message
      if (userAction == 2) {
